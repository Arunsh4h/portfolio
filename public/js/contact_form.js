...
function arunshah_Contact_Form() {
    // Form Fields
    ...
    // Contact Form
    if ( jQuery('.arunshah-contact-form:not(.is-init)').length ) {
        jQuery('.arunshah-contact-form:not(.is-init)').each(function() {
            let $form = jQuery(this),
                $response = $form.find('.arunshah-contact-form__response'),
                formData;
            ...
            $form.on('submit', function(e) {
                ...
                .done(function(response) {
                    ...
                    $response.empty().removeClass('arunshah-alert-danger').addClass('arunshah-alert-success').slideDown(200);
                ...
                .fail(function(data) {
                    $form.removeClass('is-busy');
                    $response.empty().removeClass('arunshah-alert-success').addClass('arunshah-alert-danger').slideDown(200);
