...
const AnimatedBackground = () => {
  ...
  useEffect(() => {
    ...
    const celestialSVGs = [ICUN1, ICUN2, ICUN3, ICUN4, ICUN5, ICUN6, ICUN7, ICUN8, ICUN9, ICUN10, ICUN11, ICUN12, ICUN13, ICUN14, ICUN15, ICUN16, ICUN17, ICUN18, ICUN19, ICUN20, ICUN21, ICUN22];
  ...
  return (
    <div ref={bgRef} className="fixed inset-0 pointer-events-none overflow-hidden" />
  );
};
  ...
  useEffect(() => {
    const loadAnimations = async () => {
      const animations = await Promise.all(
        services.map(() => getRandomLottieAnimation())
      );
...
case 6:
      ...
      default:
        return {
          ...
          hover: {
            scale: 1.1,
            rotate: 3,
            boxShadow: '0px 15px 40px rgba(255, 0, 83, 0.5), 0px 30px 60px rgba(0, 255, 128, 0.3), 0px 45px 80px rgba(0, 122, 255, 0.2)',
          },
  ...
  return (
    <>
      <AnimatedBackground />
      <animated.div style={springProps} className="mx-auto my-auto p-3 md:p-6 lg:p-12 relative">
...
<motion.h4
  className="relative z-10 m-0 text-white font-sans font-bold text-3xl"
  whileHover={{
